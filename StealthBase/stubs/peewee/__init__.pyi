...
class Context:
    ...
    def value(
        self, value, converter: Incomplete | None = ..., add_param: bool = ...
    ): ...
...
class ColumnBase(Node):
    ...
    def asc(
        self, collation: Incomplete | None = ..., nulls: Incomplete | None = ...
    ): ...
    __pos__: Incomplete
    def desc(
        self, collation: Incomplete | None = ..., nulls: Incomplete | None = ...
...
class Value(ColumnBase):
    ...
    values: Incomplete
    def __init__(
        self, value, converter: Incomplete | None = ..., unpack: bool = ...
    ) -> None: ...
    def __sql__(self, ctx): ...
...
class Database(_callable_context_manager):
    ...
    def random(self): ...
    def bind(
        self, models, bind_refs: bool = ..., bind_backrefs: bool = ...
    ) -> None: ...
...
class SqliteDatabase(Database):
    ...
    def pragma(
        self, key, value=..., permanent: bool = ..., schema: Incomplete | None = ...
    ): ...
    ...
    def register_function(
        self, fn, name: Incomplete | None = ..., num_params: int = ...
    ) -> None: ...
...
class VirtualField(MetaField):
    ...
    def __init__(
        self, field_class: Incomplete | None = ..., *args, **kwargs
    ) -> None: ...
    def db_value(self, value): ...
    def python_value(self, value): ...
    model: Incomplete
...
class SchemaManager:
    ...
    def __init__(
        self, model, database: Incomplete | None = ..., **context_options
    ) -> None: ...
    @property
    def database(self): ...
    @database.setter
    ...
    def drop_all(
        self, safe: bool = ..., drop_sequences: bool = ..., **options
    ) -> None: ...
...
class Model:
    ...
    @classmethod
    def drop_table(
        cls, safe: bool = ..., drop_sequences: bool = ..., **options
    ) -> None: ...
    @classmethod
